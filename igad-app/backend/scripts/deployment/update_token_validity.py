...
def update_token_validity(cognito_client, user_pool_id, client_id):
    ...
    try:
        ...
        print(f"  AccessTokenValidity: {client_config.get('AccessTokenValidity', 'Not set')}")
        print(f"  IdTokenValidity: {client_config.get('IdTokenValidity', 'Not set')}")
        print(f"  RefreshTokenValidity: {client_config.get('RefreshTokenValidity', 'Not set')}")
        ...
        for key in ['ExplicitAuthFlows', 'SupportedIdentityProviders', 'CallbackURLs', 
                   'LogoutURLs', 'AllowedOAuthFlows', 'AllowedOAuthScopes', 'AllowedOAuthFlowsUserPoolClient']:
