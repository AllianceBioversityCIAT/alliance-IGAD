...
class BedrockService:
    ...
    async def preview_prompt(self, request: PromptPreviewRequest) -> PromptPreviewResponse:
        ...
        try:
            ...
            logger.info(f"Bedrock preview completed in {processing_time:.2f}s, {tokens_used} tokens")
