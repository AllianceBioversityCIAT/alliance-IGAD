...
import { newsletterStepConfig } from '../pages/newsletterStepConfig'
...
export function NewsletterSidebar({
  ...
  const totalSteps = newsletterStepConfig.length
  ...
  return (
    <div className={styles.sidebar}>
      <div className={styles.sidebarContent}>
        ...
        <div className={styles.progressHeader}>
          <div className={styles.progressInfo}>
            <h3 className={styles.progressTitle}>Newsletter Progress</h3>
        ...
        {/* Steps List */}
        <div className={styles.stepsList}>
          {newsletterStepConfig.map((step, index) => {
            ...
            return (
              <div key={step.id} className={styles.sidebarStep}>
                <div className={styles.stepIndicator}>
                  ...
                  {index < newsletterStepConfig.length - 1 && (
                    <div
